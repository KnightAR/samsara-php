...
> \Swagger\Client\Model\V1DispatchRoute v1createDispatchRoute($create_dispatch_route_params)
...
$create_dispatch_route_params = new \Swagger\Client\Model\V1DispatchRouteCreate(); // \Swagger\Client\Model\V1DispatchRouteCreate | 
...
------------- | ------------- | ------------- | -------------
 **create_dispatch_route_params** | [**\Swagger\Client\Model\V1DispatchRouteCreate**](../Model/V1DispatchRouteCreate.md)|  |

### Return type

[**\Swagger\Client\Model\V1DispatchRoute**](../Model/V1DispatchRoute.md)
...
> \Swagger\Client\Model\V1DispatchRoutes v1fetchAllDispatchRoutes($end_time, $duration)
...
[**\Swagger\Client\Model\V1DispatchRoutes**](../Model/V1DispatchRoutes.md)
...
> \Swagger\Client\Model\V1allRouteJobUpdates v1fetchAllRouteJobUpdates($sequence_id, $include)
...
[**\Swagger\Client\Model\V1allRouteJobUpdates**](../Model/V1allRouteJobUpdates.md)
...
> \Swagger\Client\Model\V1DispatchRoute v1getDispatchRouteById($route_id)
...
> \Swagger\Client\Model\V1DispatchRouteHistory v1getDispatchRouteHistory($route_id, $start_time, $end_time)
...
[**\Swagger\Client\Model\V1DispatchRouteHistory**](../Model/V1DispatchRouteHistory.md)
...
> \Swagger\Client\Model\V1DispatchRoute v1updateDispatchRouteById($route_id, $update_dispatch_route_params)
...
$route_id = 789; // int | ID of the dispatch route. Must contain only digits 0-9.
$update_dispatch_route_params = new \Swagger\Client\Model\V1DispatchRouteUpdate(); // \Swagger\Client\Model\V1DispatchRouteUpdate | 
...
------------- | ------------- | ------------- | -------------
 **route_id** | **int**| ID of the dispatch route. Must contain only digits 0-9. |
 **update_dispatch_route_params** | [**\Swagger\Client\Model\V1DispatchRouteUpdate**](../Model/V1DispatchRouteUpdate.md)|  |
