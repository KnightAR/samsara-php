...
# **createUser**
> \Swagger\Client\Model\InlineResponse2006 createUser($user)
...
$user = new \Swagger\Client\Model\UserCreate(); // \Swagger\Client\Model\UserCreate | The user to create.
...
------------- | ------------- | ------------- | -------------
 **user** | [**\Swagger\Client\Model\UserCreate**](../Model/UserCreate.md)| The user to create. | [optional]
...
# **getUserById**
> \Swagger\Client\Model\InlineResponse2007 getUserById($id)
...
# **updateUserById**
> \Swagger\Client\Model\InlineResponse2007 updateUserById($id, $user)
...
$id = "id_example"; // string | Unique identifier for the user.
$user = new \Swagger\Client\Model\UserUpdate(); // \Swagger\Client\Model\UserUpdate | Updates to the user.
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| Unique identifier for the user. |
 **user** | [**\Swagger\Client\Model\UserUpdate**](../Model/UserUpdate.md)| Updates to the user. | [optional]
