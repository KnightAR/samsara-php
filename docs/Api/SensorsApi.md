...
# **v1getSensors**
> \Swagger\Client\Model\InlineResponse20013 v1getSensors($v1group_id_body_param)
...
$v1group_id_body_param = new \Swagger\Client\Model\V1groupIdBodyParam(); // \Swagger\Client\Model\V1groupIdBodyParam | Group ID
...
------------- | ------------- | ------------- | -------------
 **v1group_id_body_param** | [**\Swagger\Client\Model\V1groupIdBodyParam**](../Model/V1groupIdBodyParam.md)| Group ID | [optional]
...
# **v1getSensorsCargo**
> \Swagger\Client\Model\V1CargoResponse v1getSensorsCargo($v1sensor_param)
...
$v1sensor_param = new \Swagger\Client\Model\V1sensorParam(); // \Swagger\Client\Model\V1sensorParam | Group ID and list of sensor IDs to query.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v1sensor_param** | [**\Swagger\Client\Model\V1sensorParam**](../Model/V1sensorParam.md)| Group ID and list of sensor IDs to query. |

### Return type

[**\Swagger\Client\Model\V1CargoResponse**](../Model/V1CargoResponse.md)
...
# **v1getSensorsDoor**
> \Swagger\Client\Model\V1DoorResponse v1getSensorsDoor($v1sensor_param)
...
$v1sensor_param = new \Swagger\Client\Model\V1sensorParam1(); // \Swagger\Client\Model\V1sensorParam1 | Group ID and list of sensor IDs to query.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v1sensor_param** | [**\Swagger\Client\Model\V1sensorParam1**](../Model/V1sensorParam1.md)| Group ID and list of sensor IDs to query. |

### Return type

[**\Swagger\Client\Model\V1DoorResponse**](../Model/V1DoorResponse.md)
...
# **v1getSensorsHistory**
> \Swagger\Client\Model\V1SensorHistoryResponse v1getSensorsHistory($history_param)
...
[**\Swagger\Client\Model\V1SensorHistoryResponse**](../Model/V1SensorHistoryResponse.md)
...
> \Swagger\Client\Model\V1HumidityResponse v1getSensorsHumidity($v1sensor_param)
...
$v1sensor_param = new \Swagger\Client\Model\V1sensorParam2(); // \Swagger\Client\Model\V1sensorParam2 | Group ID and list of sensor IDs to query.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v1sensor_param** | [**\Swagger\Client\Model\V1sensorParam2**](../Model/V1sensorParam2.md)| Group ID and list of sensor IDs to query. |

### Return type

[**\Swagger\Client\Model\V1HumidityResponse**](../Model/V1HumidityResponse.md)
...
> \Swagger\Client\Model\V1TemperatureResponse v1getSensorsTemperature($v1sensor_param)
...
$v1sensor_param = new \Swagger\Client\Model\V1sensorParam3(); // \Swagger\Client\Model\V1sensorParam3 | Group ID and list of sensor IDs to query.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v1sensor_param** | [**\Swagger\Client\Model\V1sensorParam3**](../Model/V1sensorParam3.md)| Group ID and list of sensor IDs to query. |

### Return type

[**\Swagger\Client\Model\V1TemperatureResponse**](../Model/V1TemperatureResponse.md)
