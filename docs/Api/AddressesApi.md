...
# **createAddress**
> \Swagger\Client\Model\InlineResponse200 createAddress($address)
...
$address = new \Swagger\Client\Model\AddressCreate(); // \Swagger\Client\Model\AddressCreate | The address to create.
...
------------- | ------------- | ------------- | -------------
 **address** | [**\Swagger\Client\Model\AddressCreate**](../Model/AddressCreate.md)| The address to create. | [optional]
...
# **getAddressById**
> \Swagger\Client\Model\InlineResponse200 getAddressById($id)
...
# **updateAddressById**
> \Swagger\Client\Model\InlineResponse200 updateAddressById($id, $address)
...
$id = "id_example"; // string | Unique Samsara ID for the address
$address = new \Swagger\Client\Model\AddressPatch(); // \Swagger\Client\Model\AddressPatch | The address fields to update.
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| Unique Samsara ID for the address |
 **address** | [**\Swagger\Client\Model\AddressPatch**](../Model/AddressPatch.md)| The address fields to update. | [optional]
