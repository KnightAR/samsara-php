...
# **getVehicleById**
> \Swagger\Client\Model\InlineResponse2003 getVehicleById($id)
...
# **getVehicleLocations**
> \Swagger\Client\Model\VehicleLocationsSnapshotResponse getVehicleLocations($after, $tag_ids, $vehicle_ids)
...
[**\Swagger\Client\Model\VehicleLocationsSnapshotResponse**](../Model/VehicleLocationsSnapshotResponse.md)
...
> \Swagger\Client\Model\VehicleLocationsListResponse getVehicleLocationsFeed($after, $tag_ids, $vehicle_ids)
...
[**\Swagger\Client\Model\VehicleLocationsListResponse**](../Model/VehicleLocationsListResponse.md)
...
> \Swagger\Client\Model\VehicleLocationsListResponse getVehicleLocationsHistory($start_time, $end_time, $after, $tag_ids, $vehicle_ids)
...
# **getVehicleStatsFeed**
> \Swagger\Client\Model\VehicleStatsListResponse getVehicleStatsFeed($types, $after, $tag_ids, $vehicle_ids)
...
[**\Swagger\Client\Model\VehicleStatsListResponse**](../Model/VehicleStatsListResponse.md)
...
> \Swagger\Client\Model\VehicleStatsListResponse getVehicleStatsHistory($start_time, $end_time, $types, $after, $tag_ids, $vehicle_ids)
...
# **listVehiclesKondo**
> \Swagger\Client\Model\VehicleListResponse listVehiclesKondo($limit, $after, $tag_ids)
...
[**\Swagger\Client\Model\VehicleListResponse**](../Model/VehicleListResponse.md)
...
# **updateVehicleById**
> \Swagger\Client\Model\InlineResponse2003 updateVehicleById($id, $vehicle_patch_body)
...
$vehicle_patch_body = new \Swagger\Client\Model\VehiclePatch(); // \Swagger\Client\Model\VehiclePatch | Fields that can be patched on a vehicle.
 ...
 **vehicle_patch_body** | [**\Swagger\Client\Model\VehiclePatch**](../Model/VehiclePatch.md)| Fields that can be patched on a vehicle. | [optional]
