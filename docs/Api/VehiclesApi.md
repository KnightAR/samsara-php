...
# **getVehicleById**
> \Samsara\Php\Client\Model\InlineResponse2007 getVehicleById($id)
...
> \Samsara\Php\Client\Model\InlineResponse2006 getVehicleStatsSnapshot($types, $after, $tag_ids, $vehicle_ids)
...
# **updateVehicleById**
> \Samsara\Php\Client\Model\InlineResponse2007 updateVehicleById($id, $body)
...
$body = new \Samsara\Php\Client\Model\VehiclePatch(); // \Samsara\Php\Client\Model\VehiclePatch | Fields that can be patched on a vehicle.

try {
    $result = $apiInstance->updateVehicleById($id, $body);
    print_r($result);
} catch (Exception $e) {
 ...
 **body** | [**\Samsara\Php\Client\Model\VehiclePatch**](../Model/VehiclePatch.md)| Fields that can be patched on a vehicle. | [optional]
