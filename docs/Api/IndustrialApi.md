...
> \Swagger\Client\Model\V1VisionRunsByCameraResponse getVisionRunsByCamera($camera_id, $duration_ms, $end_ms)
...
[**\Swagger\Client\Model\V1VisionRunsByCameraResponse**](../Model/V1VisionRunsByCameraResponse.md)
...
# **v1getAllDataInputs**
> \Swagger\Client\Model\InlineResponse20011 v1getAllDataInputs($start_ms, $end_ms)
...
# **v1getCameras**
> \Swagger\Client\Model\V1VisionCamerasResponse v1getCameras()
...
[**\Swagger\Client\Model\V1VisionCamerasResponse**](../Model/V1VisionCamerasResponse.md)
...
# **v1getDataInput**
> \Swagger\Client\Model\V1DataInputHistoryResponse v1getDataInput($data_input_id, $start_ms, $end_ms)
...
[**\Swagger\Client\Model\V1DataInputHistoryResponse**](../Model/V1DataInputHistoryResponse.md)
...
# **v1getMachines**
> \Swagger\Client\Model\InlineResponse20012 v1getMachines()
...
> \Swagger\Client\Model\V1MachineHistoryResponse v1getMachinesHistory($history_param)
...
$history_param = new \Swagger\Client\Model\HistoryParam(); // \Swagger\Client\Model\HistoryParam | Time range to query for events
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **history_param** | [**\Swagger\Client\Model\HistoryParam**](../Model/HistoryParam.md)| Time range to query for events |

### Return type

[**\Swagger\Client\Model\V1MachineHistoryResponse**](../Model/V1MachineHistoryResponse.md)
...
> \Swagger\Client\Model\V1VisionRunByCameraResponse v1getVisionLatestRunCamera($camera_id, $program_id, $started_at_ms, $include, $limit)
...
[**\Swagger\Client\Model\V1VisionRunByCameraResponse**](../Model/V1VisionRunByCameraResponse.md)
...
> \Swagger\Client\Model\V1ProgramsForTheCameraResponse v1getVisionProgramsByCamera($camera_id)
...
[**\Swagger\Client\Model\V1ProgramsForTheCameraResponse**](../Model/V1ProgramsForTheCameraResponse.md)
...
# **v1getVisionRuns**
> \Swagger\Client\Model\V1VisionRunsResponse v1getVisionRuns($duration_ms, $end_ms)
...
[**\Swagger\Client\Model\V1VisionRunsResponse**](../Model/V1VisionRunsResponse.md)
...
> \Swagger\Client\Model\V1VisionRunsByCameraAndProgramResponse v1getVisionRunsByCameraAndProgram($camera_id, $program_id, $started_at_ms, $include)
...
[**\Swagger\Client\Model\V1VisionRunsByCameraAndProgramResponse**](../Model/V1VisionRunsByCameraAndProgramResponse.md)
