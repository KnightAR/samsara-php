...
class VehiclePatch implements ModelInterface, ArrayAccess
{
    ...
    public function setLicensePlate($license_plate)
    {
        if (!is_null($license_plate) && (mb_strlen($license_plate) > 12)) {
            throw new \InvalidArgumentException('invalid length for $license_plate when calling VehiclePatch., must be smaller than or equal to 12.');
        }
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 255)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling VehiclePatch., must be smaller than or equal to 255.');
        }
    ...
    public function setVin($vin)
    {
        if (!is_null($vin) && (mb_strlen($vin) > 17)) {
            throw new \InvalidArgumentException('invalid length for $vin when calling VehiclePatch., must be smaller than or equal to 17.');
        }
