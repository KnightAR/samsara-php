...
class UserUpdate implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UserUpdate., must be smaller than or equal to 255.');
        }
     ...
     * Sets roles
     *
     * @param \Samsara\Php\Client\Model\UserRoleInput[] $roles The roles for this user. Users must have at least a single role to be a part of an organization.
     *
     * @return $this
     */
