...
/**
 * V1DispatchJobDocumentInfo Class Doc Comment
 *
 * @category Class
 * @package  Samsara\Php\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1DispatchJobDocumentInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V1DispatchJobDocumentInfo';
     ...
     * Sets driver_id
     *
     * @param int $driver_id ID of driver that submitted the document.
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id ID of document. This can be used to query for the document's info via the /v1/fleet/drivers/{driver_id}/documents/{document_id} endpoint
     *
     * @return $this
     */
