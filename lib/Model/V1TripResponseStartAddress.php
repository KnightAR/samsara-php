...
/**
 * V1TripResponseStartAddress Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1TripResponseStartAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'V1TripResponse_startAddress';
...
'name' => 'getName'    ];
     ...
     * Sets id
     *
     * @param float $id The ID of the address
     *
     * @return $this
     */
