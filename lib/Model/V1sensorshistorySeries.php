...
/**
 * V1sensorshistorySeries Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1sensorshistorySeries implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1sensorshistory_series';
    ...
    const FIELD_CARGO_PERCENT = 'cargoPercent';
    ...
    const FIELD_DOOR_CLOSED = 'doorClosed';
     ...
     * Sets widget_id
     *
     * @param int $widget_id V1Sensor ID to query.
     *
     * @return $this
     */
