...
/**
 * VehicleEngineState Class Doc Comment
 *
 * @category Class
 * @package  Samsara\Php\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VehicleEngineState implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VehicleEngineState';
     ...
     * Sets value
     *
     * @param string $value Engine state of the vehicle as read by the vehicle gateway.
     *
     * @return $this
     */
