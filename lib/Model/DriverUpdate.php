...
/**
 * DriverUpdate Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DriverUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DriverUpdate';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['username']) && (mb_strlen($this->container['username']) > 189)) {
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DriverUpdate., must be smaller than or equal to 255.');
        }
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling DriverUpdate., must be smaller than or equal to 4096.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling DriverUpdate., must be smaller than or equal to 255.');
        }
    ...
    {
        if (!is_null($username) && (mb_strlen($username) > 189)) {
            throw new \InvalidArgumentException('invalid length for $username when calling DriverUpdate., must be smaller than or equal to 189.');
        }
        if (!is_null($username) && (mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling DriverUpdate., must be bigger than or equal to 1.');
        }
