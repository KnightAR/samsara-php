...
/**
 * UserRoleInput Class Doc Comment
 *
 * @category Class
 * @package  Samsara\Php\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserRoleInput implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserRoleInput';
...
'tag_id' => 'getTagId'    ];
     ...
     * Sets role_id
     *
     * @param string $role_id The id of the role the user has been granted.
     *
     * @return $this
     */
     ...
     * Sets tag_id
     *
     * @param string $tag_id The id of the tag used to grant a role. If no tag is specified, this role applies at the organization level.
     *
     * @return $this
     */
