...
class Driver implements ModelInterface, ArrayAccess
{
    ...
    public function setNotes($notes)
    {
        if (!is_null($notes) && (mb_strlen($notes) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $notes when calling Driver., must be smaller than or equal to 4096.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 255)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Driver., must be smaller than or equal to 255.');
        }
    ...
    public function setUsername($username)
    {
        if (!is_null($username) && (mb_strlen($username) > 189)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Driver., must be smaller than or equal to 189.');
        }
        if (!is_null($username) && (mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Driver., must be bigger than or equal to 1.');
        }
