...
class AddressesApi
{
     ...
     * Create an address
     *
     * @param  \Samsara\Php\Client\Model\AddressCreate $body The address to create. (optional)
     *
    ...
    public function createAddressWithHttpInfo($body = null)
    {
        ...
        $request = $this->createAddressRequest($body);
     ...
     */
    public function createAddressAsync($body = null)
    {
        return $this->createAddressAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAddressAsyncWithHttpInfo($body = null)
    {
        $returnType = '\Samsara\Php\Client\Model\InlineResponse2001';
        $request = $this->createAddressRequest($body);
     ...
     */
    protected function createAddressRequest($body = null)
    {
     ...
     */
    public function getAddresses($limit = null, $after = null, $tag_ids = null)
    {
     ...
     */
    public function getAddressesWithHttpInfo($limit = null, $after = null, $tag_ids = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAddressesAsync($limit = null, $after = null, $tag_ids = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAddressesAsyncWithHttpInfo($limit = null, $after = null, $tag_ids = null)
    {
        $returnType = '\Samsara\Php\Client\Model\InlineResponse200';
        $request = $this->getAddressesRequest($limit, $after, $tag_ids);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAddressesRequest($limit = null, $after = null, $tag_ids = null)
    {
     ...
     *
     * @param  string $id Unique Samsara ID for the address (required)
     * @param  \Samsara\Php\Client\Model\AddressPatch $body The address fields to update. (optional)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Samsara\Php\Client\Model\InlineResponse2001
     */
    public function updateAddressById($id, $body = null)
    {
        list($response) = $this->updateAddressByIdWithHttpInfo($id, $body);
        return $response;
    }
     ...
     * @return array of \Samsara\Php\Client\Model\InlineResponse2001, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateAddressByIdWithHttpInfo($id, $body = null)
    {
        $returnType = '\Samsara\Php\Client\Model\InlineResponse2001';
        $request = $this->updateAddressByIdRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAddressByIdAsync($id, $body = null)
    {
        return $this->updateAddressByIdAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAddressByIdAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Samsara\Php\Client\Model\InlineResponse2001';
        $request = $this->updateAddressByIdRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateAddressByIdRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
