...
class IndustrialApi
{
     ...
     * Get machine history
     *
     * @param  \Samsara\Php\Client\Model\HistoryParam $history_param Time range to query for events (required)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Samsara\Php\Client\Model\V1MachineHistoryResponse
     */
    public function v1getMachinesHistory($history_param)
    {
        list($response) = $this->v1getMachinesHistoryWithHttpInfo($history_param);
        return $response;
    }
     ...
     */
    public function v1getMachinesHistoryWithHttpInfo($history_param)
    {
        $returnType = '\Samsara\Php\Client\Model\V1MachineHistoryResponse';
        $request = $this->v1getMachinesHistoryRequest($history_param);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1getMachinesHistoryAsync($history_param)
    {
        return $this->v1getMachinesHistoryAsyncWithHttpInfo($history_param)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1getMachinesHistoryAsyncWithHttpInfo($history_param)
    {
        $returnType = '\Samsara\Php\Client\Model\V1MachineHistoryResponse';
        $request = $this->v1getMachinesHistoryRequest($history_param);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function v1getMachinesHistoryRequest($history_param)
    {
        // verify the required parameter 'history_param' is set
        if ($history_param === null || (is_array($history_param) && count($history_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $history_param when calling v1getMachinesHistory'
            );
        }
