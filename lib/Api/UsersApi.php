...
class UsersApi
{
     ...
     * Create a user
     *
     * @param  \Samsara\Php\Client\Model\UserCreate $user The user to create. (optional)
     *
     ...
     * @return object
     */
    public function getUserRoles($limit = '512', $after = null)
    {
     ...
     */
    public function getUserRolesWithHttpInfo($limit = '512', $after = null)
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserRolesAsync($limit = '512', $after = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserRolesAsyncWithHttpInfo($limit = '512', $after = null)
    {
        $returnType = 'object';
        $request = $this->getUserRolesRequest($limit, $after);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUserRolesRequest($limit = '512', $after = null)
    {
        if ($limit !== null && $limit > 512) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling UsersApi.getUserRoles, must be smaller than or equal to 512.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling UsersApi.getUserRoles, must be bigger than or equal to 1.');
        }
     ...
     * @return object
     */
    public function getUsers($limit = '512', $after = null)
    {
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUsersWithHttpInfo($limit = '512', $after = null)
    {
        $returnType = 'object';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUsersAsync($limit = '512', $after = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUsersAsyncWithHttpInfo($limit = '512', $after = null)
    {
        $returnType = 'object';
        $request = $this->getUsersRequest($limit, $after);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getUsersRequest($limit = '512', $after = null)
    {
        if ($limit !== null && $limit > 512) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling UsersApi.getUsers, must be smaller than or equal to 512.');
        }
        if ($limit !== null && $limit < 1) {
     ...
     *
     * @param  string $id Unique identifier for the user. (required)
     * @param  \Samsara\Php\Client\Model\UserUpdate $user Updates to the user. (optional)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Samsara\Php\Client\Model\InlineResponse2007
     */
    public function updateUserById($id, $user = null)
    {
        list($response) = $this->updateUserByIdWithHttpInfo($id, $user);
        return $response;
    }
     ...
     * @return array of \Samsara\Php\Client\Model\InlineResponse2007, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateUserByIdWithHttpInfo($id, $user = null)
    {
        $returnType = '\Samsara\Php\Client\Model\InlineResponse2007';
        $request = $this->updateUserByIdRequest($id, $user);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserByIdAsync($id, $user = null)
    {
        return $this->updateUserByIdAsyncWithHttpInfo($id, $user)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateUserByIdAsyncWithHttpInfo($id, $user = null)
    {
        $returnType = '\Samsara\Php\Client\Model\InlineResponse2007';
        $request = $this->updateUserByIdRequest($id, $user);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateUserByIdRequest($id, $user = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
