...
class MaintenanceApi
{
     ...
     * Create a DVIR
     *
     * @param  \Samsara\Php\Client\Model\CreateDvirParam $create_dvir_param DVIR creation body (required)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Samsara\Php\Client\Model\V1DvirBase
     */
    public function v1createDvir($create_dvir_param)
    {
        list($response) = $this->v1createDvirWithHttpInfo($create_dvir_param);
        return $response;
    }
     ...
     */
    public function v1createDvirWithHttpInfo($create_dvir_param)
    {
        $returnType = '\Samsara\Php\Client\Model\V1DvirBase';
        $request = $this->v1createDvirRequest($create_dvir_param);
     ...
     */
    public function v1createDvirAsync($create_dvir_param)
    {
        return $this->v1createDvirAsyncWithHttpInfo($create_dvir_param)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1createDvirAsyncWithHttpInfo($create_dvir_param)
    {
        $returnType = '\Samsara\Php\Client\Model\V1DvirBase';
        $request = $this->v1createDvirRequest($create_dvir_param);
     ...
     */
    protected function v1createDvirRequest($create_dvir_param)
    {
        ...
        if ($create_dvir_param === null || (is_array($create_dvir_param) && count($create_dvir_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_dvir_param when calling v1createDvir'
            );
        }
