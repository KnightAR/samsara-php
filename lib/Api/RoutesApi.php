...
class RoutesApi
{
     ...
     * Create a new route
     *
     * @param  \Samsara\Php\Client\Model\V1DispatchRouteCreate $create_dispatch_route_params create_dispatch_route_params (required)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Samsara\Php\Client\Model\V1DispatchRoute
     */
    public function v1createDispatchRoute($create_dispatch_route_params)
    {
        list($response) = $this->v1createDispatchRouteWithHttpInfo($create_dispatch_route_params);
        return $response;
    }
     ...
     * Create a new route
     *
     * @param  \Samsara\Php\Client\Model\V1DispatchRouteCreate $create_dispatch_route_params (required)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Samsara\Php\Client\Model\V1DispatchRoute, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1createDispatchRouteWithHttpInfo($create_dispatch_route_params)
    {
        $returnType = '\Samsara\Php\Client\Model\V1DispatchRoute';
        $request = $this->v1createDispatchRouteRequest($create_dispatch_route_params);
     ...
     */
    public function v1createDispatchRouteAsync($create_dispatch_route_params)
    {
        return $this->v1createDispatchRouteAsyncWithHttpInfo($create_dispatch_route_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1createDispatchRouteAsyncWithHttpInfo($create_dispatch_route_params)
    {
        $returnType = '\Samsara\Php\Client\Model\V1DispatchRoute';
        $request = $this->v1createDispatchRouteRequest($create_dispatch_route_params);
     ...
     */
    protected function v1createDispatchRouteRequest($create_dispatch_route_params)
    {
        ...
        if ($create_dispatch_route_params === null || (is_array($create_dispatch_route_params) && count($create_dispatch_route_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_dispatch_route_params when calling v1createDispatchRoute'
            );
        }
     ...
     *
     * @param  int $route_id ID of the dispatch route. Must contain only digits 0-9. (required)
     * @param  \Samsara\Php\Client\Model\V1DispatchRouteUpdate $update_dispatch_route_params update_dispatch_route_params (required)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Samsara\Php\Client\Model\V1DispatchRoute
     */
    public function v1updateDispatchRouteById($route_id, $update_dispatch_route_params)
    {
        list($response) = $this->v1updateDispatchRouteByIdWithHttpInfo($route_id, $update_dispatch_route_params);
        return $response;
    }
     ...
     *
     * @param  int $route_id ID of the dispatch route. Must contain only digits 0-9. (required)
     * @param  \Samsara\Php\Client\Model\V1DispatchRouteUpdate $update_dispatch_route_params (required)
     *
     * @throws \Samsara\Php\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Samsara\Php\Client\Model\V1DispatchRoute, HTTP status code, HTTP response headers (array of strings)
     */
    public function v1updateDispatchRouteByIdWithHttpInfo($route_id, $update_dispatch_route_params)
    {
        $returnType = '\Samsara\Php\Client\Model\V1DispatchRoute';
        $request = $this->v1updateDispatchRouteByIdRequest($route_id, $update_dispatch_route_params);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1updateDispatchRouteByIdAsync($route_id, $update_dispatch_route_params)
    {
        return $this->v1updateDispatchRouteByIdAsyncWithHttpInfo($route_id, $update_dispatch_route_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function v1updateDispatchRouteByIdAsyncWithHttpInfo($route_id, $update_dispatch_route_params)
    {
        $returnType = '\Samsara\Php\Client\Model\V1DispatchRoute';
        $request = $this->v1updateDispatchRouteByIdRequest($route_id, $update_dispatch_route_params);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function v1updateDispatchRouteByIdRequest($route_id, $update_dispatch_route_params)
    {
        // verify the required parameter 'route_id' is set
        if ($route_id === null || (is_array($route_id) && count($route_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($update_dispatch_route_params === null || (is_array($update_dispatch_route_params) && count($update_dispatch_route_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_dispatch_route_params when calling v1updateDispatchRouteById'
            );
        }
